...
public class SunshineDigitalWatchFaceService extends CanvasWatchFaceService {
    private static String TAG = SunshineDigitalWatchFaceService.class.getSimpleName();
    ...
    private class Engine extends CanvasWatchFaceService.Engine implements DataApi.DataListener,
        ...
        public void onDraw(Canvas canvas, Rect bounds) {
            ...
            boolean is24Hour = DateFormat.is24HourFormat(SunshineDigitalWatchFaceService.this);
